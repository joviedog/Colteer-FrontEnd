                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row row-grid" v-for="(item, index) in this.sessions" :key="index">
                                    <div class="col-lg-8" v-if="index % 3 === 0 && categorias[item.category]==='Animales'">
                                    ...
                                    <div class="col-lg-8" v-if="index % 3 === 1 && categorias[item.category]==='Animales'">
                                        <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <div class="col-lg-8" v-if="index % 3 === 2  && categorias[item.category]==='Animales'">
                                        <card class="border-0" hover shadow body-classes="py-5">
