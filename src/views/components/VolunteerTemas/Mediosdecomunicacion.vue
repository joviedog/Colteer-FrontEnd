                    ...
                    <section class="section-shaped my-0">
                        ...
                        <div class="container shape-container d-flex">
                            <div class="col px-0">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <h1 class="display-3  text-white">Lista de voluntariados con tema Medios de comunicación y radiodifusión</h1>  
                                        <div>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row row-grid" v-for="(item, index) in this.sessions" :key="index">
                                    ...
                                    <div class="col-lg-8" v-if="categorias[item.category]==='Medios de comunicación y radiodifusión'">
